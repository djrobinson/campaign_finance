...
module.exports = {
  ...
  getGraphAsc: function(cand_id){
    return knex('cmte_cand_linkage')
            ...
            .select('cmte_cand_linkage.CAND_ID', 'cmte_cand_linkage.CMTE_ID', 'committee_master.CMTE_NM', 'committee_summaries.cas_on_han_clo_of_per', 'committee_summaries.net_con', 'committee_summaries.tot_dis', 'committee_summaries.lin_ima')
