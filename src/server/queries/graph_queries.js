...
module.exports = {
  getTopCom: function(cmte){
    return knex('cmte_to_cmte')
            ...
            .select('cmte_to_cmte.CMTE_ID', 'cmte_to_cmte.OTHER_ID', 'cmte_to_cmte.TRANSACTION_AMT', 'committee_summaries.cas_on_han_clo_of_per', 'committee_summaries.tot_rec', 'committee_summaries.tot_dis', 'committee_master.CMTE_TP', 'committee_master.CMTE_NM', 'cmte_to_cmte.IMAGE_NUM')
  ...
  getTopComSecondary: function(cmte){
    return knex('cmte_to_cmte')
            .innerJoin('committee_master', 'committee_master.CMTE_ID', 'cmte_to_cmte.OTHER_ID')
            .innerJoin('committee_summaries', 'committee_summaries.com_id', 'cmte_to_cmte.OTHER_ID')
            .select('cmte_to_cmte.CMTE_ID', 'cmte_to_cmte.OTHER_ID', 'cmte_to_cmte.TRANSACTION_AMT', 'committee_master.CMTE_NM', 'cmte_to_cmte.IMAGE_NUM', 'committee_master.CMTE_TP', 'committee_summaries.cas_on_han_clo_of_per', 'committee_summaries.tot_rec', 'committee_summaries.tot_dis')
